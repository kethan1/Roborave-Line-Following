...
class Hall_Effect_Sensor:
    def __init__(self, pin: int, callback=None, bouncetime: int=200):
        ...
        GPIO.add_event_detect(self.pin_num, GPIO.FALLING, callback=callback, bouncetime=bouncetime)
    ...
    def swap_event_detect(self):
        ...
        if self.callback is not None:
            GPIO.add_event_detect(self.pin_num, GPIO.RISING, callback=self.callback, bouncetime=self.bouncetime)
